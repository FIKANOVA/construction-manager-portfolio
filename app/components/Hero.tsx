            ...
            <div className="absolute inset-x-0 bottom-0 top-20 z-0 flex justify-center items-end">
                <div className="relative w-full h-full max-w-4xl">
                    <Image
                        ...
                        fill
                        priority
                        className="object-contain object-bottom opacity-90 [mask-image:radial-gradient(ellipse_at_center,black_25%,transparent_70%)]"
                    />
                </div>
            </div>

            {/* Layer 3: Neutral Gradient Overlay (Replacing blue) */}
            <div className="absolute inset-0 z-10 bg-gradient-to-t from-black via-black/40 to-black/60" />
